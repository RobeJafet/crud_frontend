...
function consultar() {
    ...
    $.ajax({
        ...
        success: function(result) {
            ...
            // Use Promise.all to ensure all requests are completed before processing
            let promises = productos.map(producto_carrito => {
                return $.ajax({
                    ...
                    let descuentoHtml = descuento > 0
                        ? `<p class="discount">$${producto_carrito.costo - (producto_carrito.costo * (descuento / 100))}</p>
                           <p>$${(producto_carrito.costo - (producto_carrito.costo * (descuento / 100))) * producto_carrito.cantidad}</p>`
                            ...
                            <div class="container-white">
                                ...
                                <div class="d-flex justify-content-between mt-auto pt-15">
                                    <div class="box-quantity">
                                        <a href="#" class="plus-sym decrease-quantity">
            ...
            // Once all AJAX requests are done, append the HTML
    ...
    if (cantidad > 1) {
        ...
        $.ajax({
            ...
            success: function(response) {
                // Optionally refresh cart or update the HTML dynamically
                consultar();
            },
